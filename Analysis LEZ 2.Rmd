...
pv_timeline +
  ...
  annotate("rect", xmin = 0.5, xmax=1.5, ymin=0.5, ymax=Inf,
           alpha = 0.2,
           fill = "black", size = 1.5) +
  annotate("rect", xmin = 12.5, xmax=13.5, ymin=0.5, ymax=Inf,
           alpha = 0.2,
           fill = "black", size = 1.5) +
  ...
  annotate("rect", xmin = 1, xmax=Inf, ymin=2.5, ymax=31.5,
           ...
           fill = NA, size = 1.5) +
  # Text
  geom_curve(aes(x = 8*12-4, y = 40, xend = 33.5+12, yend = 34), 
             colour = "black", 
             size=1, 
             curvature = -0.2,
             arrow = arrow(length = unit(0.03, "npc"))
             ) +
  geom_label(aes(x = 8*12-4, y = 40, 
                 label = "End of Scrappage Program"), 
             hjust = 0, 
             vjust = 0.5, 
             colour = "black", 
             fill = "white",
