...
nuts_time <- nuts_time %>%
  mutate(gva_rate_agriculture = gva_A/gva_tot,
         gva_rate_industry = `gva_B_E`/gva_tot,
         gva_rate_construction = `gva_F`/gva_tot, 
         gva_rate_local_trade = `gva_G_J`/gva_tot,#  Wholesale and retail trade, transport, accommodation and food service activities
         gva_rate_work = `gva_K_N`/gva_tot,
         gva_rate_public = `gva_O_U`/gva_tot)
...
ggplot() +
  ...
  scale_size_continuous(labels = scales::label_dollar(prefix = "€")) +
